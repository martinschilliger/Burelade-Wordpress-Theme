				...
				<?php elseif ( get_bloginfo( 'description' ) || get_bloginfo( 'title' ) ) : ?>
					...
					<h1 class="blog-title">
						<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>" rel="home">
							<span class="bloginfo-title"><?php echo esc_attr( get_bloginfo( 'title' ) ); ?></span><span class="bloginfo-dash"> &mdash; </span><span class="bloginfo-description"><?php echo esc_attr( get_bloginfo( 'description' ) ); ?></span>
						</a>
					</h1>
		...
		<div class="mobile-menu-container hidden">
			...
			<ul class="mobile-menu">
			 ...
			 <form method="get" class="mobile-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<input type="search" placeholder="<?php echo "Suchen nach…"; // _e( 'Search form', 'radcliffe' ); ?>" name="s" id="s" />
