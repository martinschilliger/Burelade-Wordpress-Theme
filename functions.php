	...
	function radcliffe_load_style() {
		...
		if ( ! is_admin() ) {
			...
			if ( 'off' !== $google_fonts ) {
				...
				wp_enqueue_style( 'radcliffe_googlefonts', '//fonts.googleapis.com/css?family=Open+Sans:300,400,400italic,600,700,700italic,800|Crimson+Text:400,400italic,700,700italic|Love+Ya+Like+A+Sister' );
