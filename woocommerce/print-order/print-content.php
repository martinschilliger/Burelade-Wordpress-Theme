            ...
            <?php if (sizeof($order->get_items()) > 0): ?>
               <?php foreach ($order->get_items() as $item): ?>
                  ...
                  if (
                      ...
                      $item_meta = new WC_Order_Item_Product(
                          $item["item_meta"],
                          $product
                      );
                  } else {
                  ...
                  <tr>
                     <td class="product-name">
                        ...
                        <span class="name">
                        <?php
                        $addon_name = $item->get_meta(
                            "_wc_pao_addon_name",
                            true
                        );
                        $addon_value = $item->get_meta(
                            "_wc_pao_addon_value",
                            true
                        );
                     ...
                     <td class="product-item-price">
                        <span><?php echo wcdn_get_formatted_item_price(
                            $order,
                            $item
                        ); ?></span>
                     </td>
                     ...
                     <td class="product-price">
                        <span><?php echo $order->get_formatted_line_subtotal(
                            $item
                        ); ?></span>
                     </td>
                  </tr>
         ...
         <tfoot>
            <?php if ($totals = $order->get_order_item_totals()): ?>
               <?php foreach ($totals as $total): ?>
                  <tr>
                     <td class="total-name"><span><?php echo $total[
                         "label"
                     ]; ?></span></td>
                     <td class="total-item-price"></td>
                     <td class="total-quantity"></td>
                     <td class="total-price"><span><?php echo $total[
                         "value"
                     ]; ?></span></td>
                  </tr>
               <?php endforeach; ?>
